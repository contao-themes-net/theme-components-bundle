...
$GLOBALS['TL_LANG']['tl_page']['theme_components_legend'] = 'Theme component settings';
...
$GLOBALS['TL_LANG']['tl_page']['enable_auto_high_contrast'] = ['Automatic switch to high-contrast mode', 'Automatically switches to high-contrast mode when the system settings change, for example when Dark Mode is enabled or disabled.'];
...
$GLOBALS['TL_LANG']['tl_page']['animateOnScroll'] = [
    'Enable scroll animation effects (slide-in)',
    'If enabled, the required CSS and JavaScript files will be loaded. Elements can use the classes reveal, reveal-left, reveal-right or reveal-up to create a slide-in effect when scrolling.'
];
