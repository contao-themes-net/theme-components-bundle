...
$GLOBALS['TL_LANG']['tl_page']['enable_text_size'] = ['Autoriser l\'affichage de l\'icône de modification de la taille des caractères', 'Permet d\'afficher l\'icône de modification de la taille de la police. Cette fonction est réalisée ici par le biais d\'un lien vers une page contenant des informations sur la modification de la taille de la police. La taille de la police elle-même n\'est pas modifiée.'];
$GLOBALS['TL_LANG']['tl_page']['text_size_comment_page'] = ['Sélectionnez ici la page sur laquelle vous souhaitez expliquer la taille des caractères.', 'Étant donné que tous les navigateurs modernes prennent en charge le changement de la taille des caractères, cette fonction ne devrait plus être réalisée par Javascript ou des feuilles de style. Au lieu de cela, il est plus simple de proposer des informations sur la modification de la taille de la police sur une page séparée.'];
