...
class ReplaceInsertTagsListener
{
    ...
    private const SVG_CIRCLE_TEMPLATE = "<button onclick='%s' title='%s'><svg xmlns='http://www.w3.org/2000/svg' height='48' width='48' class='%s'><title>%s</title><desc>%s</desc><path fill='currentColor' d='M24 44q-4.15 0-7.8-1.575-3.65-1.575-6.35-4.275-2.7-2.7-4.275-6.35Q4 28.15 4 24t1.575-7.8Q7.15 12.55 9.85 9.85q2.7-2.7 6.35-4.275Q19.85 4 24 4t7.8 1.575q3.65 1.575 6.35 4.275 2.7 2.7 4.275 6.35Q44 19.85 44 24t-1.575 7.8q-1.575 3.65-4.275 6.35-2.7 2.7-6.35 4.275Q28.15 44 24 44Zm1-3q6.85-.5 11.425-5.3Q41 30.9 41 24q0-6.9-4.575-11.7Q31.85 7.5 25 7Z'/></svg></button>";
