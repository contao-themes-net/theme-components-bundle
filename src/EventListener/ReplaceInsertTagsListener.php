...
class ReplaceInsertTagsListener
{
    ...
    private const SVG_SIZE_TEMPLATE = "<svg xmlns='http://www.w3.org/2000/svg' height='48' width='48' class='%s'><title>%s</title><path fill='currentColor' d='M28.5 40V13H18V8h26v5H33.5v27Zm-18 0V23H4v-5h18v5h-6.5v17Z'/></svg>";
    /**
